...
class EditOrderController extends GetxController {
  ...
  void initializeControllers(Map<String, dynamic> orderInfo) {
    var id = orderInfo['orderId'] ?? '';
    dateController.text = orderInfo['orderDate'] ?? '';
    currencySymbolController.text = orderInfo['currencySymbol'] ?? '';
    currencyRateController.text = orderInfo['currencyRate'] != null
        ? '${orderInfo['currencyRate']}'
        : '';
  }
